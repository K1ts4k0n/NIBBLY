...
export default function RootLayout({ children }: Readonly<{children: React.ReactNode}>) { return <html lang="th"><body><LanguageProvider><CartProvider><Navbar/><FloatingSnacks/>{children}<Footer/><CartDrawer/></CartProvider></LanguageProvider></body></html>; }
